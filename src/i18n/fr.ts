...
const translation: Ii18n = {
  ...
  GnuPGFunctionIsNotSupportedInVersion1x: 'GnuPG: La fonction n\'est pas supportée dans la version 1.x',
  GnuPGFunctionIsNotSupportedInVersion2x: 'GnuPG: La fonction n\'est pas supportée dans la version 2.x',
