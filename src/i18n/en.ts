...
const translation: Ii18n = {
  ...
  GnuPGFunctionIsNotSupportedWithVersion1x: 'GnuPG: Function is not supported with gpg v1.x',
  GnuPGFunctionIsNotSupportedWithVersion2x: 'GnuPG: Function is not supported with gpg v2.x',
