...
const translation: Ii18n = {
  ...
  GnuPGFunctionIsNotSupportedWithVersion1x: 'GnuPG: Funktion ist nicht unterstützt mit gpg v1.x',
  GnuPGFunctionIsNotSupportedWithVersion2x: 'GnuPG: Funktion ist nicht unterstützt mit gpg v2.x',
